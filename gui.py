...
import threading
from trainer import ApexTrainer

class ApexGUI:
    def __init__(self):
        self.trainer = ApexTrainer()
        self.root = tk.Tk()
        self.root.title("Hades II Trainer X 1.0.0")
    ...
    def build_ui(self):
        header = tk.Label(self.root, text="HADES II TRAINER X", bg="#1a1a2e", fg="#f50283",
